...
public final class ShapeDef {
    ...
    public static ShapeDef cluster() {
        return new ShapeDef(CLUSTER, AmountDef.of(4), AmountDef.of(1), AmountDef.of(12), CIRCLE, false, "", "", Collections.emptyList(), AmountDef.of(1), true, true, 8, 4, 8, "", "", false, false, "", 100);
    }
