...
public final class ContentLargeVein implements IContentShape {
    ...
    public ContentLargeVein(AmountDef size, boolean sparse, boolean spindly) {
        this.size = size;
        this.sparse = sparse;
            ...
            for (int blocksBranch = 0; blocksBranch <= branchSize; ) {
                ...
                if (random.nextInt(3) == 0) {
                    ...
                    for (int blocksSubBranch = 0; blocksSubBranch <= subBranchSize; ) {
                        ...
                        placed |= placer.place(random, posX2, posY2, posZ2);
                        if (sparse) {
                            blocksVein++;
                            blocksBranch++;
                        }
                ...
                placed |= placer.place(random, posX, posY, posZ);
                blocksBranch++;
            }
    ...
    private static int stride(RandomSource random) {
