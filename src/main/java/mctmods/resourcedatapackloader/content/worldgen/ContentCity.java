...
public final class ContentCity {
    ...
    public static int sewerVineChance() { return Math.clamp(ContentControl.number(ContentControl.VILLAGES, "villageSewerVineChance", Config.worldgen.villageSewerVineChance()), 0, 100); }
