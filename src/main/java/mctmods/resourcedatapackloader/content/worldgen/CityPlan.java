...
public final class CityPlan {
    ...
    public static int railTail() { return Math.min(TAIL_MOST, Math.max(0, ContentControl.number(ContentControl.VILLAGES, "villageRailTail", Config.worldgen.villageRailTail()))); }
