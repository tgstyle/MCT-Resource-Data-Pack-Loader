...
public final class ContentCityClaim {
    ...
    public static void veinEnds(int x, int y, int z) {
        Vein vein = VEIN.get();
        if (vein.spared > 0 && vein.ore != null) { ContentLog.LOGGER.debug("A {} vein at {}, {}, {} was kept out of the ground under a railway bed {} time(s), where it would have fallen away", ForgeRegistries.BLOCKS.getKey(vein.ore.getBlock()), x, y, z, vein.spared); }
        vein.lines = List.of();
    }
