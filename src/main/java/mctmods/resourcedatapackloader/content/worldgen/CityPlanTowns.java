...
final class CityPlanTowns {
    ...
    @Nullable static CityPlan railed(CityGround ground, int districtX, int districtZ) {
        ...
        String type = tied.isEmpty() ? CityGround.VILLAGE_TYPES.getFirst() : ground.villageStyle(CityPlan.windowOf(districtX, true) + size / 2, CityPlan.windowOf(districtZ, false) + size / 2);
