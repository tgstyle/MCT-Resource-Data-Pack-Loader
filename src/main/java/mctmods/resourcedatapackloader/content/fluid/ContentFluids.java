...
public final class ContentFluids {
    ...
    public static final class Made {
        ...
        public final ForgeFlowingFluid.Source still;
        ...
        Made(FluidDef def) {
            ...
            ForgeFlowingFluid.Properties properties = new ForgeFlowingFluid.Properties(() -> type, this::getStill, this::getFlowing);
        ...
        public ForgeFlowingFluid.Flowing getFlowing() { return flowing; }
