...
@Mod(ResourceDataPackLoader.MOD_ID) public class ResourceDataPackLoader {
    ...
    public ResourceDataPackLoader(IEventBus modBus, ModContainer container) {
        ...
        NeoForge.EVENT_BUS.addListener(ContentPregen::onServerStarted);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onServerStopping);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onServerTick);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onLogin);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onLogout);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onDimensionChange);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onTravel);
        NeoForge.EVENT_BUS.addListener(ContentPregen::onTeleport);
