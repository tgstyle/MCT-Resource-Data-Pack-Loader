...
@Mod(ResourceDataPackLoader.MOD_ID) public class ResourceDataPackLoader {
    ...
    public ResourceDataPackLoader(IEventBus modBus, ModContainer container) {
        ...
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onUse);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onUseOn);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onDig);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onAttack);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onPlace);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onPickup);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onJoin);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onLogin);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onOpen);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onTick);
        NeoForge.EVENT_BUS.addListener(ContentDisabledEvents::onChunk);
        ...
        NeoForge.EVENT_BUS.addListener(CardEvents::onDimension);
        NeoForge.EVENT_BUS.addListener(CardEvents::onRespawn);
        NeoForge.EVENT_BUS.addListener(CardEvents::onDeath);
        NeoForge.EVENT_BUS.addListener(CardEvents::onAdvancement);
        NeoForge.EVENT_BUS.addListener(CardEvents::onCraft);
        NeoForge.EVENT_BUS.addListener(CardEvents::onPickup);
        NeoForge.EVENT_BUS.addListener(CardEvents::onLogout);
        NeoForge.EVENT_BUS.addListener(CardScan::onTick);
        ...
        NeoForge.EVENT_BUS.addListener(Toasts::onLogin);
