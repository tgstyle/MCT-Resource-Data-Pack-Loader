...
@Mixin(WorldGenTaiga1.class) public class MixinWorldGenTaiga1 {
    @ModifyConstant(method = "generate", constant = @Constant(intValue = 1, ordinal = 2)) private int getMinGenHeight(int orig, World worldIn, Random rand, BlockPos position) {
