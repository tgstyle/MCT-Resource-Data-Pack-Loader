...
public final class ConfigChunks {
    ...
    private final ForgeConfigSpec.BooleanValue saysBackground;
    private final ForgeConfigSpec.ConfigValue<String> saysFont;
    private final ForgeConfigSpec.BooleanValue toasts;
    ...
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> spawnChunkRadii;

    ConfigChunks(ForgeConfigSpec.Builder builder) {
