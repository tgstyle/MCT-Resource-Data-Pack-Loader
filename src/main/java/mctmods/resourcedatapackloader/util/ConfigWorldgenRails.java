...
public abstract class ConfigWorldgenRails extends ConfigWorldgenStreets {
    ...
    private final ModConfigSpec.BooleanValue villageRailLinks;
    private final ModConfigSpec.IntValue villageRailLinkLeast;
    private final ModConfigSpec.IntValue villageRailLinkMost;
    private final ModConfigSpec.IntValue villageRailLinkBridgeMost;
    private final ModConfigSpec.IntValue villageRailLinkTunnelMost;
    private final ModConfigSpec.ConfigValue<String> villageRailLinkStation;
    private final ModConfigSpec.IntValue villageRailLinkStationLength;
    private final ModConfigSpec.IntValue villageRailLinkPlatformWidth;
    private final ModConfigSpec.ConfigValue<String> villageRailLinkPlatformBlock;
    ...
    ConfigWorldgenRails(ModConfigSpec.Builder builder) {
        super(builder);
