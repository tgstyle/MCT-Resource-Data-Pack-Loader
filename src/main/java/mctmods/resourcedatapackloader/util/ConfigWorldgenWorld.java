...
public abstract class ConfigWorldgenWorld {
    ...
    private final ForgeConfigSpec.BooleanValue worldLanCommands;
    private final ForgeConfigSpec.ConfigValue<String> worldForceGameMode;
    private final ForgeConfigSpec.ConfigValue<String> worldPvp;
    private final ForgeConfigSpec.ConfigValue<String> worldFlight;
    private final ForgeConfigSpec.IntValue worldSpawnProtection;
    private final ForgeConfigSpec.ConfigValue<String> worldNether;
    private final ForgeConfigSpec.ConfigValue<String> worldCommandBlocks;
    private final ForgeConfigSpec.IntValue worldIdleTimeout;
    private final ForgeConfigSpec.ConfigValue<String> worldMotd;
    private final ForgeConfigSpec.IntValue worldMaxSize;
    private final ForgeConfigSpec.ConfigValue<String> worldStructures;
    private final ForgeConfigSpec.ConfigValue<String> worldSpawnMonsters;
    private final ForgeConfigSpec.ConfigValue<String> worldSpawnAnimals;
    private final ForgeConfigSpec.ConfigValue<String> worldSpawnNpcs;
    private final ForgeConfigSpec.IntValue worldViewDistance;
    private final ForgeConfigSpec.IntValue worldSimulationDistance;
    ...
    private final ForgeConfigSpec.ConfigValue<String> flatBedrockFiller;
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> flatBedrockFillers;
    private final ForgeConfigSpec.ConfigValue<List<? extends String>> flatBedrockBiomeTypes;
    private final ForgeConfigSpec.BooleanValue flatBedrockRetrogen;
    private final ForgeConfigSpec.ConfigValue<String> flatBedrockRetrogenKey;
    ...
    private final ForgeConfigSpec.BooleanValue dragonFight;
    ...
    ConfigWorldgenWorld(ForgeConfigSpec.Builder builder) {
        ...
        worldLanCommands = builder.comment("Let a player opening a single player world to LAN turn commands on for everyone who joins. Off, the Allow Cheats button on the Open to LAN screen is grayed out and stays off, and the world is opened to LAN without commands however it is asked for [Default=true]").define("worldLanCommands", true);
