...
public abstract class ConfigWorldgenStreets extends ConfigWorldgenWorld {
    ...
    private final ModConfigSpec.BooleanValue villageTieStreets;
    ...
    private final ModConfigSpec.ConfigValue<String> villagePathVergeBlock;
    private final ModConfigSpec.ConfigValue<String> villagePathVergeWaterBlock;
    ...
    ConfigWorldgenStreets(ModConfigSpec.Builder builder) {
        super(builder);
